...
export const getHomeInfo = () => {
  return (dispatch) => {
    ...
    axios.get('https://raw.staticdn.net/KK6666/jianshu/dev/public/api/home.json')
      .then((res) => {
...
export const loadMoreArticle = (page) => {
  return (dispatch) => {
    ...
    axios.get('https://raw.staticdn.net/KK6666/jianshu/dev/public/api/articleList.json?page=' + page)
      .then((res) => {
